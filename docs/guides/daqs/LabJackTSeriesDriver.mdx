...
The `LabJackTSeriesDriver` provides a driver that can be used to instantiate an instance of [InstroDAQ](/daq).

## Creating an [`InstroDAQ`](/daq) with `LabJackTSeriesDriver`
