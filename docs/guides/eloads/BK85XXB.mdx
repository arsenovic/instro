...
import BKPrecision85xx from "/snippets/instruments/electronic-loads/bk-precision-85xx.mdx";

<BKPrecision85xx />

The `BK85XXB` provides a driver that can be used to instantiate an instance of [InstroELoad](/eload).

## Creating an [`InstroELoad`](/eload) with `BK85XXB`
