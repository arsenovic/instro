...
The `AlicatMC` provides a driver that can be used to instantiate an instance of [InstroFlowController](/flowcontroller).

## Creating an [`InstroFlowController`](/flowcontroller) with `AlicatMC`
