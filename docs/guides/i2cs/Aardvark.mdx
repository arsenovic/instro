...
The `Aardvark` provides a driver that can be used to instantiate an instance of [I2CInterface](/library/protocols/i2c/overview).

## Creating an [`I2CInterface`](/library/protocols/i2c/overview) with `Aardvark`
