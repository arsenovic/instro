...
This pages gives a conceptual overview of how `instro`  is structured.
 

## Instrument
[`Instrument`][instrument-link] is the base class for [all instrument types](./supported-instruments). Its responsibilities include:
...
```
User defined [custom instruments](/instrumentation/custom-instruments) should subclass [`Instrument`][instrument-link]  
...
## THIS SHOUDL GO IN MIGRATION:  Backwards-compatible channel naming (`legacy_naming`)
