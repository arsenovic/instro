...
<Columns cols={2}>
  <Card title="Supported Instruments" icon="microchip" href="/instruments/supported-instruments"> </Card>
  <Card title="Quickstart" icon="rocket" href="/overview/quickstart"></Card>
  <Card title="Installation" icon="download" href="/overview/installation"> </Card>
