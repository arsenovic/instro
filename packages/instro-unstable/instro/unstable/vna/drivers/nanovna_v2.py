...
#TODO use thisfrom instro.lib.transports.visa import VisaConfig, VisaDriver
...
class NanoVNAv2(VNADriverBase):
    ...
    * `LiteVNA <https://www.zeenko.tech/litevna>`_
    ...
    def __init__(self, address: str, backend: str = "@py", timeout: int | None = None) -> None: 
        #TODO: replace with self._visa = VisaDriver(visa_resource)
    ...
    def get_snp_network(self,  ports: Sequence[int | None], cnum: int | None = None) -> skrf.Network:
        """
